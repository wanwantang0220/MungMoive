...
import {Default_Photos, MainColor} from "../../data/constant/BaseContant";
import HttpMovieManager from "../../data/http/HttpMovieManager";
import {DEFAULT_NAVBAR_HEIGHT, ParallaxScrollView} from "../../widget/ParallaxScrollView";
import ErrorBean from "../../data/http/ErrorBean";
import {show} from "../../utils/ToastUtils";
import LinearGradient from "react-native-linear-gradient";
import {
    BaseStyles, GrayBlackColor, GrayColor, GrayWhiteColor, MainBg, White,
    WhiteTextColor
...
export default class MovieDetailPage extends PureComponent {
                            ...
                            <View style={styles.intro_one}>
                                <View style={styles.intro_one_left}>
                                    <Text style={styles.intro_one_left_top_title}
                                          numberOfLines={1}>{this.state.movieData.title}</Text>
                                ...
                                <View style={styles.intro_one_right}>
                                    ...
                                    <Text style={styles.intro_one_right_number}
                                          numberOfLines={1}>
            ...
            return (
                <TouchableOpacity
                    ...
                    <View style={styles.photos_loading}>
                        <Text style={[styles.photos_item_reloadtext, {color: this.state.MainColor}]}>
                            重新加载剧照
                        </Text>
                    </View>
                </TouchableOpacity>
    ...
    requestData() {
        ...
        this.httpMovies.getMovieDetail(id)
            .then((data) => {
                console.log(data);
